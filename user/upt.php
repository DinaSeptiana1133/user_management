                  ...
                  <input type="hidden" name="id" value="<?php echo $email;?>"/> 
                    <div class="container col-sm-12">
                      <div class="form-group">
                        ...
                        <input class="text-center col sm_12" type="text" name="nama_lengkap" value=" <?php if (!isset($_GET['nama_lengkap'], $_SESSION['level']) || $_SESSION['level'] != 0) {
                    ...
                    <div class="container col-sm-12">
                      <div class="form-group">
                        ...
                        <input class="text-center col sm_12" type="text" name="email" value="<?php echo $row['email'];?>">
                      </div>
                    </div>
                  <div class="row">
                    <div class="update ml-auto mr-auto">
                      <input type="hidden" name="email" value="<?= $_SESSION['email']; ?>">
                      <input class="btn btn-block" type="submit" value="simpan" name="simpan"></td>
                    </div>
                  </div>
                  </div>
                  <?php 
